...
- **[devops-portfolio/README.md](devops-portfolio/README.md)** — подробная документация по использованию Helm chart
- **[infrastructure/serverless/README.md](infrastructure/serverless/README.md)** — деплой backend + статического фронтенда (Object Storage + API Gateway)
